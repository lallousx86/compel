...
procedure TfrmCanvasTest.Button10Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button11Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button12Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button13Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button14Click(Sender: TObject);
begin
  FCanvas.SaveCanvasToBitmap(edtText.Text);
end;

procedure TfrmCanvasTest.Button15Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button1Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button2Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button3Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button4Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button5Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button6Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button7Click(Sender: TObject);
begin
  FCanvas.ClearCanvas(FCanvas.BrushColor);
end;

procedure TfrmCanvasTest.Button8Click(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.Button9Click(Sender: TObject);
begin
  FCanvas.SetTitle(edtText.Text);
end;

procedure TfrmCanvasTest.cmdCreateClick(Sender: TObject);
begin
  FCanvas.ClearShapes;
end;

procedure TfrmCanvasTest.cmdCircleClick(Sender: TObject);
var
  r: TRect;
begin
  r := ParamAsTRect;
...
procedure TfrmCanvasTest.FormCreate(Sender: TObject);
begin
  FCanvas := nil;
  tok := TCompelTokenizer.Create;
end;

procedure TfrmCanvasTest.FormDestroy(Sender: TObject);
begin
  tok.Free;
end;

procedure TfrmCanvasTest.edtBrushColorChange(Sender: TObject);
var
  Ctrl: TLabeledEdit;
  Color: TColor;
begin
...
procedure TfrmCanvasTest.edtBrushColorDblClick(Sender: TObject);
var
  Ctrl: TLabeledEdit;
begin
  Ctrl := Sender as TLabeledEdit;
...
procedure TfrmCanvasTest.edtTextDblClick(Sender: TObject);
begin
...
function TfrmCanvasTest.ParamAsTRect: TRect;
begin
...
function TfrmCanvasTest.ParseParams: Integer;
begin
  Result := tok.Parse(lbledtParameters.Text, ', ');
end;

procedure TfrmCanvasTest.FormActivate(Sender: TObject);
const
  bOnce: Boolean = False;
begin
  if bOnce = False then
...
procedure TfrmCanvasTest.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  CreateCanvas(False);
end;

procedure TfrmCanvasTest.CreateCanvas(const ACreate: Boolean);
var
  Init: TCanvasExtInit;
begin
  if ACreate then
